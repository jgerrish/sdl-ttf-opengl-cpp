...
// We don't have #ifndef guards on this header file because it
// actually gets included multiple times, with SDL_PROC redefined
// depending on what stage in the initialization we are at.
...
SDL_PROC(GLuint, glAttachShader, (GLuint program, GLuint shader))
...
// Added by JMG 2025-03-16
SDL_PROC(void, glGetAttachedShaders,
...
// Added by JMG 2025-03-16
SDL_PROC(void, glGetProgramInfoLog,
...
// Added by JMG 2025-03-16
SDL_PROC(void, glGetShaderInfoLog,
         (GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog))
...
// Added by JMG 2025-04-02
SDL_PROC(void, glUniform3fv,
         (GLint location, GLsizei count, const GLfloat *value))

// Added by JMG 2025-03-25
SDL_PROC(void, glUniform4fv,
         (GLint location, GLsizei count, const GLfloat *value))

// Added by JMG 2025-03-25
SDL_PROC(void, glUniformMatrix4fv,
...
SDL_PROC(void, glVertexAttribPointer,
         (GLuint index, GLint size, GLenum type, GLboolean normalized,
          GLsizei stride, const void *pointer))

// The following loading function has been moved into
// test/src/sdl_opengl_tester.cpp

// TODO: Provide a wrapper around it in an initialize function for the
// library.  Or create a SDLOpenGL class that handles all this and
// owns the GL_Context smart pointer.

// do {
//   data->glVertexPointer =
//     (void (*)(GLint size, GLenum type, GLsizei stride, const GLvoid
//     *pointer)) SDL_GL_GetProcAddress("glVertexPointer");
//   if (!data->glVertexPointer) {
//     return SDL_SetError("Couldn't load GL function %s: %s",
//     "glVertexPointer", SDL_GetError());
//   }
//  } while (0);
